...
export interface BadgeProps extends React.HTMLAttributes<HTMLSpanElement> {
  variant?: 'default' | 'success' | 'warning' | 'danger' | 'info' | 'trust' | 'escrow'
  size?: 'xs' | 'sm' | 'md' | 'lg'
...
const Badge = forwardRef<HTMLSpanElement, BadgeProps>(
  ({
    ...
    const variants = {
      default: 'bg-[rgb(var(--color-bg-secondary))] text-[rgb(var(--color-text-primary))] border border-[rgb(var(--color-border-primary))]',
