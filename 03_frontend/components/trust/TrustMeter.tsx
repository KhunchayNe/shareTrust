    ...
    <div className={`flex flex-col items-center ${className}`}>
      ...
      <div className="relative inline-flex items-center justify-center">
        ...
        >
          ...
          <circle
            ...
            style={{
              filter: level >= 4 ? 'drop-shadow(0 0 8px rgba(0, 195, 0, 0.4))' : undefined
            }}
          />
        </svg>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          {showScore && (
            <div className={`font-bold ${sizes[size].fontSize} text-[rgb(var(--color-text-primary))]`}>
              {displayScore}
            </div>
          )}
      ...
      {showLabels && (
        <div className="mt-4 text-center">
          <div className={`font-semibold ${sizes[size].fontSize} text-[rgb(var(--color-text-primary))]`}>
            {levelName}
          </div>
      ...
      <div className="flex space-x-2 mt-4">
        {[1, 2, 3, 4, 5].map((l) => (
          <div
            ...
            style={{
              backgroundColor: l <= level ? getTrustLevelColor(l) : 'rgb(var(--color-bg-secondary))',
              transform: l <= level ? 'scale(1.2)' : 'scale(1)',
              boxShadow: l <= level && l >= 4 ? '0 0 8px rgba(0, 195, 0, 0.4)' : undefined
            }}
