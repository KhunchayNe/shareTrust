...
const CATEGORIES = [
  {
    name: "🎬 Streaming",
    href: "/search?category=streaming",
    color: "bg-red-100 text-red-700",
  },
  {
    name: "🧠 AI Tools",
    href: "/search?category=ai_tools",
...
const FEATURED_GROUPS: SharingGroup[] = [
  {
    ...
    description:
      "Share Netflix Premium 4K with movie lovers. 4K HDR content, multiple screens.",
    category: "streaming",
  ...
  },
  {
    ...
    description:
      "Get GPT-4 access with priority queue. Perfect for productivity and creativity.",
    category: "ai_tools",
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-blue-100">
                  Save money, share subscriptions safely
                </p>
              </div>
                        ...
                        <div className="flex items-start justify-between mb-2">
                          ...
                          {group.current_members >= group.max_members - 1 && (
                            <Badge variant="warning" size="sm" rounded>
                              ⚡ {group.max_members - group.current_members}{" "}
                              left
                            </Badge>
                          )}
                        </div>
              ...
              <Card className="hover:shadow-md transition-shadow cursor-pointer">
                <CardBody className="text-center py-6">
                  ...
                  <p className="text-sm text-gray-600">
                    Start sharing your subscription
                  </p>
                </CardBody>
              </Card>
            </Link>
            ...
            <CardBody>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Search and browse sharing groups
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Enjoy premium services at lower cost
                  </p>
                </div>
              </div>
            </CardBody>
