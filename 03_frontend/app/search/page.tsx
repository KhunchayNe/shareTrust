...
const TRENDING_KEYWORDS = ['Netflix', 'ChatGPT', 'Spotify', 'Adobe', 'Disney+', 'Midjourney']
  ...
  const mockGroups: SharingGroup[] = [
    {
      ...
      description: 'Share Netflix Premium 4K plan with up to 4 members. Perfect for movie lovers! HDR content, multiple screens supported.',
      category: 'streaming',
    ...
    },
    {
      ...
      description: 'Share ChatGPT Plus subscription. Get access to GPT-4, advanced features, and priority access during high demand.',
      category: 'ai_tools',
      ...
      subscription_details: {
        ...
        features: ['GPT-4 Access', 'Priority Queue', 'Faster Response', 'Image Generation'],
        original_price: 799,
    ...
    const performSearch = async () => {
      ...
      try {
        ...
        filteredGroups.sort((a, b) => {
          ...
          if (sortBy.field === 'trust_score') {
            aValue = a.creator.trust_score || 0
            bValue = b.creator.trust_score || 0
          }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-6">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Search Groups</h1>
            ...
            {searchQuery && (
              <div className="mb-4">
                <p className="text-gray-600">
                  {groups.length} result{groups.length !== 1 ? 's' : ''} for "{searchQuery}"
                </p>
              </div>
            )}
                    ...
                    <CardBody>
                      <div className="flex space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* Creator Info */}
                          <UserProfileCompact user={group.creator} showTrustLevel={true} />
                        </div>
