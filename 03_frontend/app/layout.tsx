...
export const metadata: Metadata = {
  ...
  description: 'ShareTrust enables safe subscription sharing through LINE integration with trust scoring, escrow payments, and fraud detection.',
  keywords: ['subscription sharing', 'LINE', 'trust scoring', 'escrow', 'fraud detection'],
